...
vignette: >
  %\VignetteIndexEntry{resources_to_learn_r}
...
* [Data Visualization: A practical introduction](http://socviz.co/) is an introduction to best practices in data visualization using `ggplot2`. It's also an introduction tutorial to R! 
...
* [Happy Git and GitHub for the useR](https://happygitwithr.com/) is a beginner introduction to using Git with R.

* Code style guides: 
  - [tidyverse style guide](https://style.tidyverse.org/)
  - [Google R style guide](https://google.github.io/styleguide/Rguide.xml)

* Some advice on project workflow: [What They Forgot to Teach You About R](https://whattheyforgot.org/index.html)
...
* Scott Cunningham's [Causal Inference: The Mixtape](http://scunning.com/mixtape.html) 
